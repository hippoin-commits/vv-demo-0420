...
import vvaiWordmarkUrl from "../../assets/vvai-wordmark.png";
...
export function VvAiLogo({ className }: { className?: string }) {
  return (
    <div
      className={cn("relative flex h-[14.835px] w-[54px] shrink-0 items-center justify-start", className)}
      data-name="VVAI"
    >
      <img
        src={vvaiWordmarkUrl}
...
export function TimestampSeparator({ time, className }: { time: string; className?: string }) {
  return (
    <div className={cn("flex justify-center w-full my-[var(--space-200)]", className)}>
